...
<strong>Data:</strong>
  ...
  <ul>
    ...
    <li>R Data: <a href="https://raw.githubusercontent.com/gboushey/2019-05-29-UCSF-R/gh-pages/data/feline-data_v2.csv" download>Feline Dataset</a></li> (right mouse click -> “Save As/Save Link As”, or left mouse click -> File menu -> “Save Page As”)
    <li>R Data: <a href="https://raw.githubusercontent.com/gboushey/2019-05-29-UCSF-R/gh-pages/data/gapminder-FiveYearData.csv" download>Gapminder Dataset</a></li> (right mouse click -> “Save As/Save Link As”, or left mouse click -> File menu -> “Save Page As”)
  </ul>
</p>
<hr/>
